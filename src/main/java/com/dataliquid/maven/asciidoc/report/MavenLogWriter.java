...
/**
 * A PrintWriter adapter that bridges asciidoc-linter's console output to
 * Maven's logging system. This class intercepts output from the
...
public class MavenLogWriter extends PrintWriter {
    ...
    /**
     * Sets the current severity level for subsequent output. This helps route
     * messages to the correct Maven log level.
     */
    ...
    /**
     * Checks if the terminal supports ANSI colors. Can be overridden by environment
