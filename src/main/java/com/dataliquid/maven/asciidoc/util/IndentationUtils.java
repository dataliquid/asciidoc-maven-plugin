...
public class IndentationUtils {
    ...
    /**
     * Removes common leading indentation from all lines while preserving relative indentation.
     * This is similar to stripIndent() but specifically designed for template content.
     * 
